...
from infer_yolo_v9.yolov9.utils import TryExcept, emojis
from infer_yolo_v9.yolov9.utils.downloads import gsutil_getsize
from infer_yolo_v9.yolov9.utils.metrics import box_iou, fitness
...
def strip_optimizer(f='best.pt', s=''):  # from infer_yolo_v9.yolov9.utils.general import *; strip_optimizer()
